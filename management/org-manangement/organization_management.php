...
<div class="main">
  ...
  <div class="content">
    ...
    <div class="dashboard-body" style="padding:18px;">
      <div class="zone-area">
        <div class="attraction-card" style="width:100%;">
          <div class="card-thumb" style="height:84px; background:linear-gradient(135deg,#cfa3d6,#9b6fb0);">
            <svg viewBox="0 0 24 24" fill="none" stroke="#fff" style="width:44px;height:44px;"><path d="M3 7h18"/><path d="M5 21h14v-8H5z"/><circle cx="12" cy="4" r="2"/></svg>
          </div>
          <div class="card-body">
      ...
      <div style="margin-top:16px; color:var(--text-muted);">(Placeholder) Add billing and organization settings UI here.</div>
    </div>
  </div>
</div>
<script>
