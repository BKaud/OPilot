...
<body>
            ...
            <div class="zone-area">
                <div class="time-strip">
                    <div>
                        ...
                        <div class="breadcrumb" style="font-size:10px;">Next rotation in <strong
                                id="rotCountdown">12:44</strong></div>
                    </div>
                    ...
                    <div class="attraction-row" id="rotationRow">
                        ...
                        <div class="attraction-card">
                            <div class="card-thumb"
                                style="background: linear-gradient(135deg, #2a9d7f, #1a6f5a); position: relative;">
                                <div class="card-status-dot"></div>
                                <svg viewBox="0 0 80 80" style="width: 50px; height: 50px; opacity: 0.9;" fill="none"
                        ...
                        <div class="attraction-card">
                            <div class="card-thumb"
                                style="background: linear-gradient(135deg, #2a7a9d, #1a5a6f); display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;">
                                <div class="card-status-dot"></div>
                                <div
                                    style="width: 70%; height: 24px; background: rgba(255,255,255,0.1); border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.2); position: relative;">
                                    <div
                                        style="height: 100%; width: 65%; background: linear-gradient(90deg, #26c9a0, #1a8f7a); transition: width 0.3s;">
                                    </div>
                                    <div
                                        style="position: absolute; right: 8px; top: 50%; transform: translateY(-50%); color: #fff; font-size: 10px; font-weight: bold;">
                                        65%</div>
                                </div>
                        ...
                        <div class="attraction-card">
                            <div class="card-thumb"
                                style="background: linear-gradient(135deg, #7a2a9d, #5a1a6f); display: flex; align-items: center; justify-content: center; flex-wrap: wrap; gap: 6px; padding: 10px;">
                                <div class="card-status-dot"></div>
                                <div
                                    style="display: grid; grid-template-columns: 1fr 1fr; gap: 4px; width: 100%; max-width: 35px;">
                                    <div
                                        style="width: 14px; height: 14px; border-radius: 2px; background: #26c9a0; border: 1px solid rgba(255,255,255,0.3);">
                                    </div>
                                    <div
                                        style="width: 14px; height: 14px; border-radius: 2px; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.3);">
                                    </div>
                                    <div
                                        style="width: 14px; height: 14px; border-radius: 2px; background: #26c9a0; border: 1px solid rgba(255,255,255,0.3);">
                                    </div>
                        ...
                        <div class="attraction-card">
                            <div class="card-thumb"
                                style="background: linear-gradient(135deg, #9d7a2a, #6f5a1a); display: flex; align-items: center; justify-content: center; position: relative;">
                                <div class="card-status-dot"></div>
                                <svg viewBox="0 0 80 80" style="width: 50px; height: 50px;" fill="none">
                                    ...
                                    <!-- Center text -->
                                    <text x="40" y="35" text-anchor="middle" font-size="14" font-weight="bold"
                                        fill="#fff">ROT</text>
                                    <text x="40" y="50" text-anchor="middle" font-size="18" font-weight="bold"
                                        fill="#f59e0b">D</text>
                                </svg>
                        ...
                        <div class="attraction-card">
                            <div class="card-thumb"
                                style="background: linear-gradient(135deg, #2a6f9d, #1a4f6f); display: flex; align-items: center; justify-content: center; position: relative;">
                                <div class="card-status-dot"></div>
                                <div style="text-align: center;">
                                    <div
                                        style="color: rgba(255,255,255,0.9); font-size: 14px; font-weight: bold; letter-spacing: 0.5px;">
                                        ROTATION D</div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 6px; margin: 8px 0;">
                                    <!-- Station 1 -->
                                    <div
                                        style="background: var(--teal-glow); border: 1px solid var(--teal); border-radius: 2px; padding: 3px 5px; text-align: center;">
                                        <div
                                            style="font-size: 7px; font-weight: 700; color: var(--teal); text-transform: uppercase; letter-spacing: 0.2px;">
                                            Station 1</div>
                                    </div>
                                    <div
                                        style="background: var(--teal-glow); border: 1px solid var(--teal); border-radius: 2px; padding: 3px 5px; text-align: center;">
                                        <div style="font-size: 7px; font-weight: 600; color: var(--teal);">H. Brown
                                        </div>
                                    </div>
                                    ...
                                    <!-- Station 4 (Empty) -->
                                    <div
                                        style="background: rgba(192, 57, 43, 0.1); border: 1px solid rgba(192, 57, 43, 0.3); border-radius: 2px; padding: 3px 5px; text-align: center;">
                                        <div
                                            style="font-size: 7px; font-weight: 700; color: var(--accent-red); text-transform: uppercase; letter-spacing: 0.2px;">
                                            Station 4</div>
                                    </div>
                                    <div
                                        style="background: rgba(192, 57, 43, 0.1); border: 1px solid rgba(192, 57, 43, 0.3); border-radius: 2px; padding: 3px 5px; text-align: center;">
                                        <div style="font-size: 7px; font-weight: 600; color: var(--accent-red);">EMPTY
                                        </div>
                                    </div>
                                </div>

                                <div class="card-operator"
                                    style="border-top: 1px solid #ddd; padding-top: 6px; margin-top: 6px;">Next:
                                    Rotation E at 12:00 PM</div>
                            </div>
                        </div>
    ...
    function populateDashboard(attractions) {
        ...
        `;
            ...
            const leadOperator = attraction.positions.find(p => p.name.toLowerCase().includes('control') || p
